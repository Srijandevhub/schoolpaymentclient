        ...
        <div className={`card h-100 ${styles.sidebar} ${toogler ? `${styles.show}` : ""}`}>
            <div className={`card-header ${styles.sidebarHeader}`}>
                <div className='d-flex justify-content-end'>
                    <button className={styles.closeBtn} onClick={() => dispatch(closeSidebar())}>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fillEule="evenodd" d="M10 4H4c-1.10457 0-2 .89543-2 2v12c0 1.1046.89543 2 2 2h6V4ZM7.79283 9.29289c.39053.39053.39053 1.02371 0 1.41421L6.5 11.9999l1.29283 1.2929c.39053.3905.39053 1.0237 0 1.4142-.39052.3905-1.02368.3905-1.41421 0l-1.99994-2c-.39052-.3905-.39052-1.0236 0-1.4142l1.99994-1.99991c.39053-.39052 1.02369-.39052 1.41421 0Z" clipRule="evenodd"/>
